    ...
    <div className="flex flex-col h-full bg-slate-950 text-slate-100 border-r border-slate-800">
      ...
      <div className="flex overflow-x-auto bg-slate-900/80 border-b border-slate-800 p-2 gap-1 shrink-0 scrollbar-none">
        {[
          ...
          { id: "coding", label: "Profiles", icon: Code2 },
          { id: "reorder", label: "Reorder", icon: Move },
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        {activeTab === "profile" && (
          <div className="space-y-4">
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onChange({
                      ...data,
                      personal: { ...data.personal, avatarUrl: e.target.value },
                    })
                  }
            ...
            <h4 className="font-semibold text-xs text-slate-400 pt-4 border-t border-slate-800">
              Social Links
            </h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
              ...
              <button
                onClick={() =>
                  openAiModal("About Summary", data.about.summary, (improved) =>
                    onChange({
                      ...data,
                      about: { ...data.about, summary: improved },
                    }),
                  )
                }
              ...
              <button
                onClick={() => {
                  const newExp: ExperienceItem = {
                    ...
                    current: true,
                    description:
                      "Described key role responsibilities and achievements.",
                  };
                  onChange({
                    ...data,
              ...
              <button
                onClick={() => {
                  const newProj: ProjectItem = {
                    ...
                    name: "New Project",
                    description:
                      "Project description showcasing skills and impact.",
              ...
              <button
                onClick={() => {
                  const newAch: AchievementItem = {
                    id: `ach_${Date.now()}`,
                    title: "Award / Hackathon Winner",
                    organization: "Organization / Event",
                    date: "2024",
                    description:
                      "Description of the award or recognition received.",
                  };
                  onChange({
                    ...data,
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    onClick={() => {
                      ...
                      onChange({ ...data, achievements: filtered });
                    }}
                    className="text-rose-400 p-1"
                  >
                    <Trash2 className="w-4 h-4" />
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    onClick={() => {
                      ...
                      onChange({ ...data, publications: filtered });
                    }}
                    className="text-rose-400 p-1"
                  >
                    <Trash2 className="w-4 h-4" />
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  value={data.codingProfiles?.leetcode || ""}
                  onChange={(e) =>
                    onChange({
                      ...data,
                      codingProfiles: {
                  ...
                  className="w-full bg-slate-900 border border-slate-800 rounded-lg p-2.5 text-sm text-slate-100 mt-1"
                />
              </div>
              <div>
                <label className="text-xs text-slate-400">
                ...
                <input
                  type="text"
                  value={data.codingProfiles?.github || ""}
                  onChange={(e) =>
                    onChange({
                      ...data,
                      codingProfiles: {
              ...
              <div>
                <label className="text-xs text-slate-400">Codeforces URL</label>
                <input
                  type="text"
                  value={data.codingProfiles?.codeforces || ""}
                  onChange={(e) =>
                    onChange({
                      ...data,
                      codingProfiles: {
              ...
              <div>
                <label className="text-xs text-slate-400">Kaggle URL</label>
                <input
                  type="text"
                  value={data.codingProfiles?.kaggle || ""}
                  onChange={(e) =>
                    onChange({
                      ...data,
                      codingProfiles: {
        ...
        {activeTab === "reorder" && (
          <div className="space-y-4">
            ...
            <p className="text-xs text-slate-400">
              Move section blocks up or down to customize the vertical layout
            ...
            <div className="space-y-2">
              {currentOrder.map((sectionKey, idx) => (
                ...
                >
                  <span className="text-xs font-bold capitalize text-cyan-300 flex items-center gap-2">
                    <Move className="w-3.5 h-3.5 text-slate-500" /> {sectionKey}{" "}
                    Section
                  </span>
        ...
        {activeTab === "visibility" && (
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              {Object.entries(data.sectionVisibility).map(
                ([key, isVisible]) => (
                  <div
                    key={key}
                    className="flex justify-between items-center p-3 bg-slate-900 border border-slate-800 rounded-xl"
                  >
                    <span className="text-xs capitalize font-medium text-slate-200">
                      {key} Section
                    </span>
                    <button
                      onClick={() =>
