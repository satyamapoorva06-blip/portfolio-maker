...
const ANIMATED_THEMES: { id: ThemeType; name: string; desc: string }[] = [
  {
    ...
    desc: "Infinite spinning text banner & dynamic slide transitions",
  },
  {
    id: "animated-laser-neon",
    name: "⚡ Cyber Laser Particle Rain",
    desc: "Laser grid sweeps with glowing particle physics",
  },
  {
    id: "animated-3d-orbs",
    name: "⚡ 3D Spatial Floating Orbs",
    desc: "Interactive 3D depth tilt & floating spatial glow",
  },
  {
    id: "animated-glitch-hacker",
    name: "⚡ Cyberpunk Matrix Glitch",
    desc: "Real-time text glitch effect & CRT scanlines",
  },
  {
    id: "animated-aurora-mesh",
    name: "⚡ Living Aurora Borealis",
    desc: "Flowing interactive mesh gradient blur",
  },
  {
    id: "animated-elastic-cards",
    name: "⚡ Elastic Physics Hover",
    desc: "Spring physics micro-interactions & elastic cards",
  },
  {
    id: "animated-particle-constellation",
    name: "⚡ Node Constellation",
    desc: "Particle network nodes connecting on hover",
  },
  {
    id: "animated-liquid-glass",
    name: "⚡ Liquid Glass Bubbles",
    desc: "Floating glass bubble blur & organic motion",
  },
  {
    id: "animated-synthwave-retro",
    name: "⚡ 8-Bit Retro Synthwave",
    desc: "Neon grid horizon & retro synthwave sunset",
  },
  {
    id: "animated-prism-refraction",
    name: "⚡ Holographic Prism Glow",
    desc: "Prism rainbow refraction & iridescent cards",
  },
];
...
const SHOWCASE_THEMES: { id: ThemeType; name: string; desc: string }[] = [
  {
    ...
    name: "1. Neural Spectrum AI",
    desc: "AI Spatial & Generative Creative Studio",
  },
  {
    id: "tvnskm-aiml-fullstack",
    name: "2. Quantum FullStack Matrix",
    desc: "Neural Network Matrix & Full Stack",
  },
  {
    id: "priyanshu-creative",
    name: "3. Generative Canvas AI",
    desc: "Generative AI & Interactive Visuals",
  },
  {
    id: "kirti-aiml",
    name: "4. Glassmorphic LLM Studio",
    desc: "Lovable Glass & Deep Learning Models",
  },
  {
    id: "harsh-aiml-mern",
    name: "5. Cyberpunk MERN Stack",
    desc: "MERN Stack & AI Cyberpunk",
  },
  {
    id: "hari-aiml",
    name: "6. Deep Learning Intelligence",
    desc: "AI Intelligence & Data Models",
  },
  {
    id: "nishil-cloud",
    name: "7. Cloud DevOps Architect",
    desc: "AWS/GCP Cloud Architecture & Terraform",
  },
  {
    id: "prince-ai",
    name: "8. Dark Obsidian Minimalist",
    desc: "Dark Minimalist AI Developer",
  },
  {
    id: "sahil-aiml-student",
    name: "9. Academic AI Scholar",
    desc: "University AI Student & Research",
  },
  {
    id: "suraj-agentic-ai",
    name: "10. Agentic AI Workflows",
    desc: "Autonomous LLM Agents & System Workflows",
  },
  {
    id: "srikhanth-arvr",
    name: "11. Vision OS Spatial 3D",
    desc: "Vision OS Spatial Glass & WebGL 3D",
  },
  {
    id: "abhinav-cv-ml",
    name: "12. Computer Vision Studio",
    desc: "PyTorch, OpenCV & Neural Vision",
  },
  {
    id: "sahil-sahu-ai",
    name: "13. Minimalist CS Dark",
    desc: "Clean Dark AI Student Showcase",
  },
  {
    id: "shreya-datascience",
    name: "14. Data Science Analytics",
    desc: "Pandas, Scikit & AI Data Analytics",
  },
  {
    id: "aman-genai",
    name: "15. GenAI RAG Systems",
    desc: "LLM Prompt Engineering & RAG Systems",
  },
  {
    id: "nikhil-fullstack",
    name: "16. Full Stack Reactive AI",
    desc: "React, Node.js & AI Integrations",
  },
  {
    id: "abhay-cs-ai",
    name: "17. CS Algorithm Systems",
    desc: "Computer Science & AI Algorithms",
  },
  {
    id: "saad-fullstack",
    name: "18. Vibrant Web Engineer",
    desc: "Vibrant Full Stack Web Developer",
  },
  {
    id: "prashant-cse-aiml",
    name: "19. CSE Research Studio",
    desc: "CSE Academic & Machine Learning",
  },
  {
    id: "anmol-creative-sys",
    name: "20. Creative Systems DevOps",
    desc: "Creative Systems & DevOps",
  },
  {
    id: "abhishek-beginner",
    name: "21. Beginner CS Scholar",
    desc: "Clean Beginner CS Student",
  },
  {
    id: "harsh-cs-student",
    name: "22. Minimal CS Developer",
    desc: "Minimal CS Student Showcase",
  },
  {
    id: "dheeraj-mern",
    name: "23. MERN Stack Neon",
    desc: "MongoDB, Express, React, Node",
  },
  {
    id: "rishav-java-backend",
    name: "24. Spring Boot Enterprise",
    desc: "Spring Boot & Microservices",
  },
  {
    id: "adil-java-microservices",
    name: "25. Java Microservices Architect",
    desc: "Enterprise Java & Database Systems",
  },
  {
    id: "megha-mern",
    name: "26. CS MERN Stack",
    desc: "MERN Stack & Computer Science",
  },
  {
    id: "harsh-backend-ai",
    name: "27. Python FastAPI AI",
    desc: "Python, FastAPI & AI Pipelines",
  },
  {
    id: "karan-webdev",
    name: "28. Responsive Web Architect",
    desc: "Responsive Web Developer",
  },
  {
    id: "shashank-fullstack",
    name: "29. Full Stack SDE Studio",
    desc: "Full Stack Software Engineer",
  },
  {
    id: "suraj-mern",
    name: "30. High-Impact MERN",
    desc: "High-Impact MERN Developer",
  },
  {
    id: "abdulhussain-uiux",
    name: "31. Figma UI/UX Design",
    desc: "Figma UI/UX & Web Design",
  },
  {
    id: "sakesh-fullstack",
    name: "32. Modern Full Stack",
    desc: "Modern Full Stack Architect",
  },
  {
    id: "arun-fullstack",
    name: "33. Personal Dev Showcase",
    desc: "Personal Developer Portfolio",
  },
  {
    id: "ritik-cybersec",
    name: "34. Cyber Security Sentinel",
    desc: "Penetration Testing & CTF Badges",
  },
  {
    id: "shivam-frontend",
    name: "35. React & Tailwind UI",
    desc: "React & Tailwind CSS Specialist",
  },
  {
    id: "vinay-java-fullstack",
    name: "36. Java Full Stack Enterprise",
    desc: "Java, Spring Boot & React",
  },
  {
    id: "subhadeep-fullstack",
    name: "37. Clean Full Stack",
    desc: "Clean Full Stack Showcase",
  },
  {
    id: "wasif-cs-student",
    name: "38. Minimalist CS Student",
    desc: "Minimalist Student Portfolio",
  },
  {
    id: "prince-shah-learning",
    name: "39. Student Learner Studio",
    desc: "Student Learner Portfolio",
  },
  {
    id: "dhanaraj-frontend-ai",
    name: "40. Next.js & AI Tools",
    desc: "Next.js, Tailwind & AI Tools",
  },
  {
    id: "ayush-iot-creative",
    name: "41. IoT Hardware Telemetry",
    desc: "Circuit Board & Hardware Telemetry",
  },
  {
    id: "priyank-fullstack",
    name: "42. Full Stack Software",
    desc: "Full Stack Web Software",
  },
  {
    id: "aadi-neobrutalist",
    name: "43. Swiss Neo-Brutalist Poster",
    desc: "Bold Swiss Neo-Brutalist Poster",
  },
  {
    id: "cs-student-collection",
    name: "44. CS Academic Collection",
    desc: "Academic University Coursework & GPA",
  },
  {
    id: "emma-bostian-curated",
    name: "45. Star Portfolio Collection",
    desc: "Top Starred Developer Collection",
  },
  {
    id: "github-topic-student",
    name: "46. Open Source Student",
    desc: "Open Source Student Showcase",
  },
  {
    id: "sitesplaced-examples",
    name: "47. SitesPlaced Engineer Examples",
    desc: "Curated Software Engineer Showcase",
  },
  {
    id: "nikola-janjic-2025",
    name: "48. 2025 Edition Collection",
    desc: "1,000+ Developer Portfolio 2025",
  },
  {
    id: "gist-inspiration",
    name: "49. Gist Inspiration Grid",
    desc: "Curated Gist Developer Showcase",
  },
  {
    id: "onehour-digital",
    name: "50. OneHour Creative Showcase",
    desc: "High-Converting Frontend Showcase",
  },
];
    ...
    <div className="space-y-8 text-slate-200 text-sm p-4">
      ...
      <div className="space-y-4">
        <h3 className="text-xs font-black text-[#e50914] uppercase tracking-wider flex items-center gap-2">
          <Crown className="w-4 h-4 text-[#e50914] animate-bounce" /> TOP 1
      ...
      <div className="space-y-4 pt-6 border-t border-slate-800">
        <h3 className="text-xs font-extrabold text-cyan-400 uppercase tracking-wider flex items-center gap-2">
          <Zap className="w-4 h-4 text-yellow-400 animate-pulse" /> 10 Animated
          Portfolio Themes
        </h3>
      ...
      <div className="space-y-4 pt-6 border-t border-slate-800">
        <h3 className="text-xs font-extrabold text-purple-300 uppercase tracking-wider flex items-center gap-2">
          <Palette className="w-4 h-4 text-purple-400" /> 50 Showcase Portfolio
          Themes
        </h3>
        ...
        <div className="flex gap-3">
          {[
            ...
            <button
              key={f.id}
              onClick={() =>
                onChange({ ...customization, fontFamily: f.id as any })
              }
