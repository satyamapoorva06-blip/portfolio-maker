...
function PublishContent() {
  ...
  if (!portfolio) return <div className="p-12 text-center text-slate-400 font-mono">Loading portfolio details...</div>;
...
export default function PublishPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans">
      ...
      <Suspense fallback={<div className="p-12 text-center text-slate-400 font-mono">Loading publish workspace...</div>}>
        <PublishContent />
      </Suspense>
    </div>
  );
