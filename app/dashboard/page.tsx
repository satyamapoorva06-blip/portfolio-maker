...
import { Plus, Eye, Edit3, Trash2, Github, Rocket, Layers, CheckCircle2, Settings, FileText, ArrowRight } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-10">
        ...
        <div className="p-8 bg-gradient-to-r from-slate-900 via-cyan-950 to-slate-900 border border-slate-800 rounded-3xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 shadow-2xl relative overflow-hidden">
          <div className="space-y-2 relative z-10">
            ...
            <p className="text-slate-300 text-sm">Create, manage, and deploy your professional portfolio websites.</p>
          </div>
            ...
            <div className="p-12 bg-slate-900/60 border border-dashed border-slate-800 rounded-3xl text-center space-y-6 max-w-xl mx-auto">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-400 text-xs leading-relaxed">
                  You haven’t created a portfolio yet. Upload your PDF or DOCX resume, and Portify AI will generate your portfolio automatically in under 3 minutes!
                </p>
              </div>
              <Link
                href="/upload"
                className="inline-flex px-6 py-3.5 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-bold rounded-2xl text-xs shadow-lg items-center gap-2 transition"
              >
                Upload Resume & Build Portfolio <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
          ) : (
