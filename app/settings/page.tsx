      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-y-10">
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-400">
            Manage your personal profile, connected GitHub account, and Vercel
        ...
        <div className="p-8 bg-slate-900 border border-slate-800 rounded-3xl space-y-6 shadow-xl">
          <h2 className="font-bold text-lg text-white border-b border-slate-800 pb-3 flex items-center gap-2">
            <User className="w-5 h-5 text-cyan-400" /> Personal Profile
            Information
          </h2>
        ...
        <div className="p-8 bg-slate-900 border border-slate-800 rounded-3xl space-y-6 shadow-xl">
          <div className="flex justify-between items-center border-b border-slate-800 pb-3">
            <h2 className="font-bold text-lg text-white flex items-center gap-2">
              <Github className="w-5 h-5 text-cyan-400" /> GitHub Account
              Integration
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setUser({ ...user, github_username: e.target.value })
                }
              ...
              <p className="text-[11px] text-slate-500 mt-1">
                Your official GitHub handle for automated repository creation.
              </p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setUser({ ...user, github_token: e.target.value })
                }
                className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3 text-sm text-white mt-1 focus:border-cyan-500 focus:outline-none font-mono"
              />
              <p className="text-[11px] text-slate-500 mt-1">
                Used to commit source code directly to your GitHub account.
              </p>
            </div>
          </div>
          ...
          <div className="p-5 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-xs font-bold text-cyan-400 flex items-center gap-2">
                <HelpCircle className="w-4 h-4 text-cyan-400" /> How to get your
                GitHub Access Token (3 Quick Steps):
              </span>
              <a
            ...
            <ol className="list-decimal list-inside text-xs text-slate-300 space-y-1.5 font-light">
              ...
              <li>
                Set Token Name to{" "}
                <strong className="text-white">&quot;Portify AI&quot;</strong>{" "}
                and check the{" "}
                <code className="text-emerald-400 bg-slate-900 px-1 py-0.5 rounded font-mono">
                  repo
                </code>{" "}
                scope (Full control of repositories).
              </li>
              <li>
                Click <strong className="text-white">Generate token</strong> at
                the bottom and copy your token starting with{" "}
                <code className="text-cyan-300 bg-slate-900 px-1 py-0.5 rounded font-mono">
                  ghp_...
                </code>{" "}
                into the box above!
              </li>
        ...
        <div className="p-8 bg-slate-900 border border-slate-800 rounded-3xl space-y-6 shadow-xl">
          <div className="flex justify-between items-center border-b border-slate-800 pb-3">
            <h2 className="font-bold text-lg text-white flex items-center gap-2">
              <Rocket className="w-5 h-5 text-emerald-400" /> Vercel Deployment
              Integration
            </h2>
            {user.vercel_token && (
              <span className="text-xs text-emerald-400 font-semibold flex items-center gap-1">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setUser({ ...user, vercel_token: e.target.value })
              }
              className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3 text-sm text-white mt-1 focus:border-cyan-500 focus:outline-none font-mono"
            />
            <p className="text-[11px] text-slate-500 mt-1">
          ...
          <div className="p-5 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-xs font-bold text-emerald-400 flex items-center gap-2">
                <HelpCircle className="w-4 h-4 text-emerald-400" /> How to get
                your Vercel Access Token (3 Quick Steps):
              </span>
              <a
            ...
            <ol className="list-decimal list-inside text-xs text-slate-300 space-y-1.5 font-light">
              <li>
                Click{" "}
                <strong className="text-white">Open Vercel Token Page</strong>{" "}
                above (or go to{" "}
              ...
              <li>
                ...
                <strong className="text-white">&quot;Portify AI&quot;</strong>,
                and select Scope:{" "}
                <strong className="text-white">Full Account</strong>.
              </li>
              <li>
                Click <strong className="text-white">Create</strong> and copy
                your generated Vercel token into the box above!
              </li>
            </ol>
          </div>
        </div>
