...
import { ArrowLeft, Save, Rocket, Github, CheckCircle2, Eye, Sparkles, X, ExternalLink, Copy, Loader2, Globe, AlertCircle, ArrowRight, Key, HelpCircle, Zap } from 'lucide-react';
