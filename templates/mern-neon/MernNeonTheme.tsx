    ...
    <div className="min-h-screen bg-[#07040d] text-purple-100 font-sans selection:bg-pink-500 selection:text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 space-y-16">
        <section className="bg-[#0f091c] border-2 border-purple-500/40 rounded-3xl p-8 sm:p-12 space-y-6 shadow-2xl">
            ...
            <div className="flex gap-3">
              {p.socials?.github && (
                <a
                  ...
                  className="p-2.5 bg-slate-900 border border-slate-800 rounded-xl text-purple-300 hover:text-cyan-400 transition"
                >
          ...
          <p className="text-xl text-purple-300 font-bold font-mono">
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {data.skills.map((grp) => (
                <div
                  key={grp.id}
                  className="p-6 bg-[#0f091c] border border-purple-900/60 rounded-2xl space-y-4"
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {grp.skills.map((sk, idx) => (
                      <span
                        key={idx}
                        className="px-3 py-1 bg-purple-950 text-purple-300 text-xs font-bold font-mono rounded-lg border border-purple-800"
                      >
                        {sk}
                      </span>
                    ))}
