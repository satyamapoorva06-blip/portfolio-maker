      ...
      <main className="max-w-4xl mx-auto px-6 py-16 space-y-12">
        ...
        {data.education && data.education.length > 0 && (
          <section className="space-y-4">
            <h2 className="text-xs font-mono text-slate-500 uppercase font-bold tracking-widest">
              EDUCATION
            </h2>
            <div className="grid grid-cols-1 gap-4">
              {data.education.map((edu) => (
                <div
                  key={edu.id}
                  className="p-4 bg-slate-900/50 border border-slate-800 rounded-xl flex justify-between items-center"
                >
                  <div>
                  ...
                  {edu.gpa && (
                    <span className="text-xs font-mono bg-slate-950 px-2 py-0.5 rounded border border-slate-800">
                      {edu.gpa}
                    </span>
                  )}
                </div>
